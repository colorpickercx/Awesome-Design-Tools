...
- [ColorTools](https://colorpicker.cx/color-picker) — a free browser-based image color picker with a color wheel, palette generator, CSS gradient builder and WCAG contrast checker. ![free.svg](https://github.com/LisaDziuba/Awesome-Design-Tools/blob/master/Media/free.svg)
